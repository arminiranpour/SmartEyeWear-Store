        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FRAME_SHAPE = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    ...
                    IMAGE_URL = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    GLASS_TYPE = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    ...
                    TONE = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    FACE_SHAPE = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    SKIN_TONE = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
